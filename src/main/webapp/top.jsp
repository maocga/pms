  ...
  <tr>
    ...
    <td width='80%' align="right" valign="bottom">
      ...
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	...
        	[<a href="${pageContext.request.contextPath}/modpassword.jsp"  target="_blank">修改密码</a>]
        	[<a href="javascript:void(0);" onClick="parent.location.href='${pageContext.request.contextPath}/login.jsp'" target="_login">注销退出</a>]&nbsp;
      </td>
      </tr>
      <tr>
