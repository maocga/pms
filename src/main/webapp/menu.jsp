...
<li><a href='baoxiao-task.jsp' target='main'>报销审批</a> </li>
	<li><a href='${pageContext.request.contextPath}/baoxiao/mybaoxiaoList/1?pages=0&searchCriteria=0&keyword=0' target='main'>我的报销</a> </li>
</ul></dd></dl>
...
<li><a href='${pageContext.request.contextPath}/empl/findAllEmp' target='main'>人员管理</a> </li>
