...
<c:forEach items="${user}" var="emp" varStatus="i">
    <tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
        <td><input name="id" type="checkbox" value="${emp.eid}" class="np"></td>
        <td>${i.count}</td>
        <td>${emp.ename}</td>
        ...
        <td>${emp.telephone}</td>
        <td>
            <fmt:formatDate value="${emp.hiredate}" timeStyle="yyyy-MM-dd"></fmt:formatDate>
        </td>
        <td>正常</td>
